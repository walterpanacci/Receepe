...
data.addEventListener("submit", function (e) {
  ...
  answerList.insertAdjacentHTML(
    ...
    `<li class="answer item">
            ...
            Walking (ca. 3 km/h) for ${walking} minutes (ca. ${(
      walking / 60
    ).toFixed(2)} hrs.)
          </li>
          <li class="answer item">
            ...
            Running (ca. 8km/h) for ${running} minutes (ca. ${(
      running / 60
    ).toFixed(2)} hrs.)
          </li>
          <li class="answer item">
            ...
            Bicycling (ca. 16 km/h) for ${bicycling} minutes (ca. ${(
      bicycling / 60
    ).toFixed(2)} hrs.)
          </li>
          <li class="answer item">
            ...
            Swimming laps for ${swimming} minutes (ca. ${(
      swimming / 60
    ).toFixed(2)} hrs.)
          </li>
          <li class="answer item">
            ...
            Weight lifting for ${weightLifting} minutes (ca. ${(
      weightLifting / 60
    ).toFixed(2)} hrs.)
          </li>`
  );
